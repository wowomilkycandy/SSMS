	...
	$(function() {	
		...
		$("#search").click(function(){
			$('#dataList').datagrid("options").queryParams = {
				gradeid: $("#gradeList").textbox('getValue'),
				clazzid: $("#clazzList").textbox('getValue'),
				number: $("#number").val(),
				name: $("#name").val()
			};
			$('#dataList').datagrid("reload");
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$("#add_birthday").textbox('setValue',"1998-01-01");
	    	...
	    	buttons: [
				...
				},
				{
					...
					handler:function(){
						...
						$("#edit_birthday").textbox('setValue',"1998-01-01");
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-left: 10px;float:left;">班级：<input id="clazzList" class="easyui-textbox" name="clazz" /></div>
		<div style="float: left; margin: 0 10px 0 10px">学号：<input id="number" class="easyui-textbox" name="number" /></div>
		<div style="float: left; margin: 0 10px 0 10px">姓名：<input id="name" class="easyui-textbox" name="name" /></div>
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
				...
				<tr>
					<td>生日:</td>
					<td><input id="add_birthday" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="birthday" data-options="required:true, missingMessage:'请填写生日xx-xx-xx'" /></td>
				</tr>
	    		<tr>
	    			<td>年级:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
				...
				<tr>
					<td>生日:</td>
					<td><input id="edit_birthday" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="birthday" data-options="required:true, missingMessage:'请填写生日xx-xx-xx'" /></td>
				</tr>
