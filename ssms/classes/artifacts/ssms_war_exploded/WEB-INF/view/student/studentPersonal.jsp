	...
	<div id="editDialog" style="padding: 20px">
    	...
    	<form id="editForm">
	    	<table cellpadding="8" >
				...
				<tr>
					<td>生日:</td>
					<td><input id="edit_birthday" value="${userDetail.birthday }" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="birthday" data-options="required:true, missingMessage:'请填写生日xx-xx-xx'" /></td>
				</tr>
	    		<tr>
	    			<td>年级:</td>
