...
import com.ssms.bean.CourseItem;
import com.ssms.bean.Grade;
import com.ssms.bean.Page;
import com.ssms.bean.Teacher;
import com.ssms.bean.User;
import com.ssms.dao.impl.TeacherDaoImpl;
import com.ssms.dao.inter.TeacherDaoInter;
...
public class TeacherService {
	...
	public void addTeacher(Teacher teacher) throws Exception {
		...
		try {
			...
			String sql = "INSERT INTO teacher(number, name, sex, photo) value(?,?,?,?)";
	...
	public void editTeacherPersonal(Teacher teacher){
		...
		String sql = "UPDATE teacher SET name=?, sex=? WHERE number=?";
