...
import com.ssms.dao.impl.StudentDaoImpl;
...
public class StudentService {
	...
	public void addStudent(Student student){
		...
		//添加学生记录
		dao.insert("INSERT INTO student(number, name, sex, birthday, clazzid, gradeid) value(?,?,?,?,?,?)",
				new Object[]{
					student.getNumber(), 
					student.getName(), 
					student.getSex(), 
	...
	public String getStudentList(Student student, Page page){
		...
		if(student != null){ 
			...
			if(!StringTool.isEmpty(student.getNumber())){
				param.add(student.getNumber());
				sb.append("AND number=? ");
			}
			if(!StringTool.isEmpty(student.getName())){
